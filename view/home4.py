...
.stMetric {
    ...
    border-radius: 15px;
    padding: 1rem;
    box-shadow: 0 2px 10px rgba(1,1,1,1.02);
}
...
with st.container():
    ...
    with kpi2:
        st.metric("Ganhos", valores["periodo"][period][1][0], delta, chart_data=data, chart_type="area")
    with kpi3:
        st.metric("Gastos", valores["periodo"][period][2][0], delta='-', chart_data=data, chart_type="line")
    with kpi4:
